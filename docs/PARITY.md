...
| Memory health/topics/stats | `icm health`, `icm topics`, `icm stats`, MCP stats/topics tools | CLI and MCP tools. | `Packet28 memory topics`, `Packet28 memory stats`; MCP `packet28.memory_topics`, `packet28.memory_stats`. | partial | Add ICM-style health/staleness/consolidation-needs report. Current evidence: `test_memory_store_recall_uses_sqlite_home_db`, `test_mcp_memory_store_recall_uses_sqlite_home_db`. |
