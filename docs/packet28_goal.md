...
- `docs/experiments/manifest.json` now records a verifier-backed manifest for runtime-live, real-repo, and fff search-backend experiments with artifact paths, commands, runtime versions, and metric gates. Evidence: `Packet28 verify experiments --root . --json`.
