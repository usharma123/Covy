...
- `docs/experiments/manifest.json` now records a verifier-backed manifest for runtime-live, repeatable fixture-suite, real-repo, fff search-backend, plan-validation, and Claude Code navigation experiments with artifact paths, commands, runtime versions, and metric gates. Evidence: `Packet28 verify experiments --root . --json`.
