...
- Hypothesis checkpoints can now carry related paths and symbols through agent snapshots, broker context rendering, CLI JSON, and MCP list output, making assumptions inspectable against concrete evidence anchors. Evidence: `active_decisions_render_related_paths_and_symbols`; updated hypothesis CLI/MCP smoke tests.
