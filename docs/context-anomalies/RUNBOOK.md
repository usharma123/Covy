...
JSON:`alias_docs_checked`,`row_soft_ok`,`row_soft_max`,`output_doc_phrases_checked`,`density_doc_phrases_checked`,`density_doc_anchors_checked`,`parsed_fields_checked`,`json_parity_fields_checked`,`density_label_line_width`,`default_output_headroom`,`text_width_docs_checked`;err:`ok:false`;h:`help<=120`.
