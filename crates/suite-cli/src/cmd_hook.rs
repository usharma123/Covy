...
use packet28_daemon_core::{
    ...
    HookBoundaryKind, HookEventKind, HookIngestRequest, HookReducerPacket, HookRuntimeConfig,
};
#[cfg(test)]
...
use crate::cmd_hook_packets::{build_reducer_packet, packet_from_parts};
...
use crate::cmd_hook_support::{
    extract_command_paths, first_nonempty_line, hook_output_text, json_nested_string, json_string,
};
