...
#[test]
fn test_mcp_context_feedback_transcript_wakeup_and_learn_project() {
    ...
    let wakeup_feedback = read_mcp_message_for_id(&mut stdout, 9);
    assert_eq!(
    ...
    let transcript = read_mcp_message_for_id(&mut stdout, 10);
    assert_eq!(
    ...
    let transcript_search = read_mcp_message_for_id(&mut stdout, 11);
    assert_eq!(
    ...
    let transcript_stats = read_mcp_message_for_id(&mut stdout, 12);
    assert_eq!(
    ...
    let transcript_export = read_mcp_message_for_id(&mut stdout, 13);
    assert_eq!(
    ...
    let transcript_import = read_mcp_message_for_id(&mut stdout, 14);
    assert_eq!(
    ...
    let wakeup = read_mcp_message_for_id(&mut stdout, 15);
    assert_eq!(
    ...
    let learned = read_mcp_message_for_id(&mut stdout, 16);
    assert_eq!(
