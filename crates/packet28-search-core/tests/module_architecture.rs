...
fn policies() -> BTreeMap<&'static str, ModulePolicy> {
    BTreeMap::from([
        ...
        (
            ...
            ModulePolicy {
                max_lines: 750,
                allowed_dependencies: &["error", "model", "paths", "postings", "state", "support"],
            },
        ),
        (
            "model",
        ...
        (
            ...
            ModulePolicy {
                max_lines: 325,
                allowed_dependencies: &["error", "model", "suffix"],
            },
        ),
        (
            "postings",
        ...
        (
            ...
            ModulePolicy {
                max_lines: 300,
                allowed_dependencies: &["error", "layer", "model", "paths", "state", "support"],
            },
        ),
        (
            "query",
